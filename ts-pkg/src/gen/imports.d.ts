...
export type Prop = PropStrng | PropNumber | PropBoolean | PropUnknown;
export interface PropStrng {
  tag: "strng",
  val: string,
}
export interface PropNumber {
  tag: "number",
  val: number,
}
export interface PropBoolean {
  tag: "boolean",
  val: boolean,
}
export interface PropUnknown {
  tag: "unknown",
}
export class Imports {
  ...
  */
  ...
  getProp(propName: string): Result<Prop, string>;
}
